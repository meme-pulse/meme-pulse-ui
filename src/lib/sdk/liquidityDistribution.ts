...
import { spotUniform, curve, bidAsk } from './liquidityConfig';
import { LiquidityDistribution, type LiquidityDistributionParams } from './types';
 ...
 */
export const getLiquidityConfig = (distribution: LiquidityDistribution): LiquidityDistributionParams => {
  switch (distribution) {
 ...
 * @returns {LiquidityDistributionParams}
 */
export const getDistributionFromTargetBin = (activeId: number, targetBin: number): LiquidityDistributionParams => {
  return {
 ...
 * @returns
 */
export const getUniformDistributionFromBinRange = (activeId: number, binRange: number[]): LiquidityDistributionParams => {
